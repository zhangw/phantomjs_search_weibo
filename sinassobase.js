var _sinaSSOEncoder = _sinaSSOEncoder || {};
(function() {
  var a = 0,
    b = 8;
    ...
    decode: function(a) {
      ...
      switch (c) {
        case "v01":
          ...
          return decodeURIComponent(j(_sinaSSOEncoder.base64.decode(b, "binnary", "array")));
        case "v02":
          d = d.replace(/\./g, "=");
          b = _sinaSSOEncoder.base64.decode(d, "urlsafe", "array");
          return j(_sinaSSOEncoder.base64.decode(b, "binnary", "array"));
        default:
  ...
  this.getSUBPCookie = {
    ...
    decode: function(a) {
      ...
      switch (d) {
        case "002":
          b = _sinaSSOEncoder.base64.decode(e, "subp_v2", "array");
          return _sinaSSOEncoder.getSUBPCookie.__parse(b);
        case "003":
          c = e.substr(0, 1);
          b = _sinaSSOEncoder.base64.decode(e, "subp_v3_" + c, "array");
          return _sinaSSOEncoder.getSUBPCookie.__parse(b);
        default:
          return decodeURIComponent(a)
      }
...
(function() {
  ...
  this.RSAKey = bq;
  this.getSuByUsername = function(username){
    return this.base64.encode(encodeURIComponent(username));
  };
}).call(_sinaSSOEncoder);

exports.sinaSSOEncoder = _sinaSSOEncoder;